...
const STORE_NAME = 'Checkers'
const SITE_BASE_URL = 'https://www.checkers.co.za'
const API_BASE_URL = 'https://api.shopritegroup.co.za/dsl/brands/checkers/countries/ZA/products'
...
export async function scrapeCheckers(query) {
  const results = []
  const seen = new Set()
