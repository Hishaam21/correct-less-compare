/**
 * Game South Africa Retailer Scraper
 * Scrapes Game search results only
...
const BASE_URL = 'https://www.game.co.za'
...
export async function scrapeGame(query) {
  try {
    console.log(`🛒 [Game] Searching for: "${query}"`)
    ...
    console.log(`✅ [Game] Found ${products.length} products`)
    return products
  } catch (error) {
    console.error(`❌ [Game] Scraping failed:`, error.message)
    throw error
  }
}
